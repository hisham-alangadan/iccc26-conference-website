...
const Departments = () => {
    ...
    <p><em>The conference is jointly organized by three leading departments of College of Engineering, Trivandrum:</em></p>

    <div className="department-section">
        <div className="department-content">
            <h2><strong>Department of Computer Science and Engineering (CSE)</strong></h2>
            <p>The CSE department at CET is at the forefront of digital innovation. Established in 1984, it has been consistently producing industry leaders and cutting-edge research. The department excels in areas such as artificial intelligence, machine learning, cybersecurity, and big data analytics. With state-of-the-art laboratories and a faculty of distinguished experts, CSE at CET is shaping the future of computing technology.</p>
        </div>
