...
const Departments = ({venue}) => {
    ...
    <div className="department-section">
        <div className="department-content">
            ...
            <a href='ee.cet.ac.in'><h4>Visit the department site</h4></a>
        </div>
    ...
    <div className="department-section">
        <div className="department-content">
            ...
            <a href='ece.cet.ac.in'><h4>Visit the department site</h4></a>
        </div>
        <div className="department-image">
    ...
    <div className="department-section">
        <div className="department-content">
            ...
            <a href='cse.cet.ac.in'><h4>Visit the department site</h4></a>
        </div>
        <div className="department-image">
